...
export const userPinIcon = new Icon({
  iconUrl:
...
// Blue pin icon for weather station location
export const stationPinIcon = new Icon({
  iconUrl:
...
export default function MapComponent({ lat, lon, onLocationSelect }: MapProps) {
