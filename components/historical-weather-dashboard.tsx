...
import { userPinIcon, stationPinIcon } from "./map-component";
    ...
    <div className="container mx-auto p-1 sm:p-4">
      <div className="space-y-4">
        ...
        {/* <Card>
          ...
          <CardContent>
            <div className="h-[250px] sm:h-[300px] rounded-md overflow-hidden">
              <MapContainer
                center={center}
                zoom={7}
              ...
              >
                ...
                {stationLocation && (
                  <Marker
                    position={[stationLocation.lat, stationLocation.lon]}
                    icon={stationPinIcon}
                  />
                )}
              </MapContainer>
